...
Route::get('pacientes/{id}/qr',[QRController::class,'index']);

Route::get('odontologia/pdf/{recId}',[PDFController::class,'pdf']);
...
Route::get('odontologia/historial/{rec_id}',[OdoPatientRecordController::class,'patientRecord']);
...
Route::apiResource('cies',CieController::class);
...
Route::apiResource('expedientes',MedicalRecordController::class)->parameters(['expedientes'=>'medicalRecord']);
