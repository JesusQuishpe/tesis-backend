...
class CreateHelicobacterPyloriTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('helicobacter_pylori', function (Blueprint $table) {
            $table->id();
            ...
            $table->string("resultado",45)->default('');
    ...
    {
        Schema::dropIfExists('helicobacter_pylori');
    }
}
