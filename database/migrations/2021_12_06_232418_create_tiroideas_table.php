...
class CreateTiroideasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tiroideas', function (Blueprint $table) {
            $table->id();
            ...
            $table->float("t3")->default(0);
            $table->float("t4")->default(0);
            $table->float("tsh")->default(0);
