...
class CreateEnfermeriaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('enfermeria', function (Blueprint $table) {
            ...
            $table->float('peso',10,2)->default(0.00);
            $table->float('estatura',10,2)->default(0.00);
            $table->float('temperatura',10,2)->default(0.00);
            ...
            $table->float('discapacidad',10,2)->default(0.00);
            $table->string('inyeccion',15)->default('');
            $table->string('curacion',15)->default('');
            $table->float('embarazo',10,2)->default(0.00);
